...
const technologies = {
  frontend: {
    ...
    items: [
      { name: "Next.js 14", description: "React framework with server-side rendering and routing" },
      ...
      { name: "Redux Toolkit", description: "State management for complex application state" },
      { name: "Session Storage", description: "Saves Search User to keep flow datausage" }
  ...
  backend: {
    ...
    items: [
      { name: "Spring Boot", description: "Java-based framework for building REST APIs" },
      { name: "Java 21", description: "Programming language for backend development" },
      { name: "PostgreSQL", description: "Relational database for data persistence" },
      { name: "Spring Security", description: "Authentication and authorization framework" },
      { name: "JWT", description: "JSON Web Tokens for secure API authentication" }
    ]
  },
  ui: {
    title: "UI Libraries",
    ...
    items: [
      { name: "Material Tailwind", description: "Material Design components for Tailwind CSS" },
      { name: "React Icons", description: "Popular icon libraries as React components" },
      { name: "Lucide Icons", description: "Clean, consistent icon library" },
      { name: "Heroicons", description: "Beautiful hand-crafted SVG icons by Tailwind team" },
      { name: "Framer Motion", description: "Production-ready animation library for React" }
    ]
  },
  tools: {
    ...
    items: [
      { name: "Fuse.js", description: "Lightweight fuzzy-search library for better search experience" },
      ...
      { name: "Fetch API", description: "Built-in web API for network requests" },
      { name: "React Query", description: "Data fetching and caching library" },
      { name: "React Slider", description: "Movie Scoring and displaying user score" }
    ]
  },
  apis: {
    title: "APIs & Services",
    ...
    items: [
      { name: "TMDB API v3", description: "The Movie Database API for movie information" },
      ...
      { name: "Railway/Render", description: "Platform for backend deployment" }
    ]
  },
  devtools: {
    ...
    items: [
      ...
      { name: "Chrome DevTools", description: "Browser debugging and performance analysis" }
    ]
  }
};
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            A comprehensive overview of all technologies, libraries, and tools used to build Iriscope
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">
                Next.js with TypeScript, deployed on Vercel with SSR/SSG optimization
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">
                RESTful API with Spring Boot, JWT authentication, and TMDB integration
              </p>
            </div>
        ...
        <div className="text-center mt-12 pb-8">
          <p className="text-xs text-gray-500">
            This tech stack represents a modern, scalable, and performant web application architecture
          </p>
        </div>
      </div>
    </div>
