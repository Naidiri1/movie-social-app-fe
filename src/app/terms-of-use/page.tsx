    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="bg-red-900/20 backdrop-blur rounded-lg p-6 mb-8 border border-red-800/50">
          <h2 className="text-xl font-bold mb-3 text-red-400">⚠️ Important Notice</h2>
          <p className="text-sm text-gray-300">
            This is a non-commercial, educational portfolio project. By using this website, you acknowledge 
            and agree that this service is provided for demonstration purposes only and is not intended 
            for commercial use.
          </p>
        </section>
        ...
        <section className="bg-gray-800/50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          ...
          <p className="text-gray-300 mb-3">
            By accessing and using Iriscope ("the Service"), you accept and agree to be bound by the terms 
            and provision of this agreement. If you do not agree to these terms, please do not use this service.
          </p>
        </section>

        <section className="bg-gray-800/50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          <h2 className="text-2xl font-bold mb-4 text-blue-400">2. Educational & Portfolio Purpose</h2>
          <div className="text-gray-300 space-y-3">
            ...
            <p className="font-semibold text-yellow-400 mt-3">
              This service is NOT intended for commercial use or profit generation.
            </p>
          </div>
        </section>

        <section className="bg-gray-800/50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          <h2 className="text-2xl font-bold mb-4 text-blue-400">3. User Accounts</h2>
          <div className="text-gray-300 space-y-3">
            ...
            <p className="text-sm text-yellow-400 mt-3">
              Note: Please do not use real personal information or 
        ...
        <section className="bg-gray-800/50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          <h2 className="text-2xl font-bold mb-4 text-blue-400">4. User-Generated Content</h2>
          <div className="text-gray-300 space-y-3">
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              ...
              <li>You grant us the right to display your content on the platform</li>
        ...
        <section className="bg-gray-800/50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          <h2 className="text-2xl font-bold mb-4 text-blue-400">6. Intellectual Property</h2>
          <div className="text-gray-300 space-y-3">
            <p>
              All movie-related content including posters, descriptions, and metadata are the property 
              of their respective copyright holders. We claim no ownership of this content.
            </p>
            <p>
              The Iriscope platform code, design, and user interface are created for educational purposes 
              and portfolio demonstration only.
            </p>
        ...
        <section className="bg-gray-800/50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          ...
          <div className="text-gray-300 space-y-3">
            ...
            <p className="font-semibold text-yellow-400">
              Important: As this is a demonstration project, please do not share sensitive personal information.
            </p>
          </div>
        </section>

        <section className="bg-gray-800/50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          <h2 className="text-2xl font-bold mb-4 text-blue-400">8. Disclaimers</h2>
          <div className="text-gray-300 space-y-3">
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              ...
              <li>Movie information accuracy is dependent on third-party APIs</li>
              <li>This is a demonstration project and may be discontinued at any time</li>
            </ul>
          </div>
        </section>
        ...
        <section className="bg-gray-800/50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          ...
          <p className="text-gray-300">
            In no event shall Iriscope, its creators, or contributors be liable for any indirect, 
        ...
        <section className="bg-gray-800/50 backdrop-blur rounded-lg p-6 mb-6 border border-gray-700">
          ...
          <p className="text-gray-300">
            ...
            sole discretion, without notice, for conduct that violates these Terms of Use or is harmful 
        ...
        <section className="bg-green-900/20 backdrop-blur rounded-lg p-6 mb-8 border border-green-800/50">
          <p className="text-center text-gray-300">
            By using Iriscope, you acknowledge that you have read, understood, and agree to be bound 
        ...
        <div className="text-center mt-12 pb-8">
          <p className="text-xs text-gray-500">
            These terms are for a demonstration/portfolio project and should not be considered 
            legally binding for commercial purposes.
          </p>
        </div>
      </div>
    </div>
