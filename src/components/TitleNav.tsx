...
export default function NavTitle({ username, orbitron }: { username?: string; orbitron: any }) {
  return (
    <Typography
      as="a"
      href="/popular"
    ...
    >
      <span className="block sm:hidden text-xs">
        {username ? (
          <>
            <span className="text-gray-400 group-hover:text-white transition-colors">Welcome </span>
      ...
      <span className="hidden sm:block md:hidden text-sm">
        {username ? (
          <>
            ...
            <span className="text-gray-400 group-hover:text-white transition-colors"> to </span>
          ...
          <>
            <span className="text-gray-400 group-hover:text-white transition-colors">Welcome to </span>
            <span className="font-black text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-yellow-400 to-orange-500">
              IRISCOPE
            </span>
          </>
      ...
      <span className="hidden md:block text-base lg:text-lg">
        {username ? (
          <>
            <span className="text-gray-400 font-light group-hover:text-white transition-all duration-300">Welcome </span>
            ...
            <span className="text-gray-400 font-light group-hover:text-white transition-all duration-300"> to </span>
          ...
          <>
            <span className="text-gray-400 font-light group-hover:text-white transition-all duration-300">Welcome to </span>
            <span className="font-black text-lg lg:text-xl text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-yellow-400 to-red-600 uppercase tracking-wider">
             IRISCOPE
            </span>
          </>
