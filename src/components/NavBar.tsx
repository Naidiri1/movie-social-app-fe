    ...
    <Navbar className=" w-full max-w-none rounded-none bg-black px-4 py-2 lg:px-8 lg:py-4">
      <div className="container w-full max-w-none flex flex-wrap items-center justify-between text-blue-gray-900">
        <Typography
          as="a"
          href="#"
          className="mr-4 text-white  cursor-pointer py-1.5 font-medium"
        >
      ...
      <Collapse open={openNav}>
        <div className="container mx-auto">
          ...
          {navList}
              ...
              <Button size='sm' onClick={handleLogout} className="flex text-white mb-3 cursor-pointer bg-red-300 hover:underline">
                 Logout
             </Button>
            </div>
